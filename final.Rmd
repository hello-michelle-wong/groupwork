...
1.  Linearity and Homoscedasticity (Constant Variance) The relationship
    ...
    (dependent variable) are linear. This means that changes in
    the predictor(s) produce proportional changes in the
...
2.  Independence: The residuals (errors) from the model appear to be
